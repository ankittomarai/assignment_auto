...
These notebooks cover different functionality and serve the purpose.
1 Data Preparation - This file explains data quality checks and fixes and output is saved as CSV file.
2.1 EDA Hypothesis Test with complete data - In this notebook, EDA is done on complete processed dataset. Decisions and conclusions are explained in comment and markdown space. 
